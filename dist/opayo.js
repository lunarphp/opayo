...
window.opayo = function (_ref) {
  ...
  return {
    ...
    init: function init() {
      ...
      new cleave_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.$refs['card'], {
        creditCard: true,
        onCreditCardTypeChanged: function onCreditCardTypeChanged(type) {
          _this.cardType = type;
        }
      });
      new cleave_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.$refs['expiry'], {
        date: true,
        datePattern: ['m', 'y']
      });
    },
      ...
      sagepayOwnForm({
        ...
        onTokenised: function onTokenised(result) {
          if (!result.success) {
            ...
            $wire.set('sessionKey', _this2.merchantKey);
            $wire.call('process');
          }
        },
        cardDetails: {
